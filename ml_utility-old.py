...
def check_df(df, outlier_cutoff=3, corr_cutoff=0.9, var_cutoff=0.001):
    ''' A function to report details about the dataframe (df)
      check if the dataframe has white space or NULL values
    '''
 ...
 # print('shape of df_delattime=', df_dtime.shape)
  ...
  #check related columns using the correation
    ...
    if len(corr_col)>0:
      ...
      print(f'The corrlation (>{corr_cutoff}) table:', '\n', dd3)
